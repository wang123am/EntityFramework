...
namespace Microsoft.EntityFrameworkCore.Metadata.Conventions.Internal
{
        ...
        IPropertyAnnotationSetConvention
    {
        ...
        public Annotation Apply(InternalIndexBuilder indexBuilder, string name, Annotation annotation, Annotation oldAnnotation)
        {
        ...
        public Annotation Apply(InternalPropertyBuilder propertyBuilder, string name, Annotation annotation, Annotation oldAnnotation)
        {
